/**
 * SAMRAT WORLDWIDE — LUXURY SALES & CUSTOMER SERVICE AI CONCIERGE CHATBOT
...
(function() {
    ...
    setTimeout(() => {
      if (text.match(/^(hi|hello|hey|salam|marhaba|assalam|kem cho|namaste)/)) {
        appendMsg(`
          ...
          Welcome to SAMRAT WORLDWIDE! Main Founder Ismail Kazia ka AI sales executive hoon. 
        ...
        appendMsg(`
          <strong>💰 SAMRAT Pricing Overview:</strong><br>
        ...
        appendMsg(`
          ...
          <a href="https://wa.me/966548905688?text=${encodeURIComponent('Hello Ismail! Connecting from SAMRAT website: ' + raw)}" target="_blank" style="display:inline-block; margin-top:6px; background:#10B981; color:#000; font-weight:bold; padding:6px 12px; border-radius:6px; text-decoration:none;">Forward to Ismail Kazia's WhatsApp →</a>
        `, 'bot');
      }
    }, 350);
  }
  ...
  // Expose globally
  window.toggleSamratChat = toggleChat;
})();
