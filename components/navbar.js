...
(function() {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const navHTML = `
  <nav class="navbar navbar-expand-lg navbar-dark nav-alsayegh" style="background:#060606; border-bottom:1px solid rgba(255,255,255,0.08); padding:12px 0;">
    <div class="container-fluid px-lg-5">
      <a href="${prefix}index.html" style="text-decoration:none; display:flex; align-items:center; gap:12px;">
        ...
        <span style="font-family:'Poppins', sans-serif; font-weight:900; font-size:1.35rem; letter-spacing:2px; color:#FFFFFF; line-height:1; display:flex; flex-direction:column; text-transform:uppercase;">
          GALICON
          <span style="font-size:0.8rem; letter-spacing:3px; font-weight:800; color:#EAB308; margin-top:2px;">GLOBAL GROUP</span>
        </span>
      </a>
