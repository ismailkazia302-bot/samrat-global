/**
 * GALICON GLOBAL — DAILY 8:30 AM OUTREACH & 3-MONTH FOLLOW-UP ENGINE
...
async function sendEmailViaBrevo({ toEmail, toName, subject, textBody, replyToEmail }) {
  ...
  const senderName = process.env.BREVO_SENDER_NAME || 'Ismail Kazia | GALICON GLOBAL';
...
I am Ismail Kazia, Founder of GALICON GLOBAL. We produce end-to-end corporate tech summits, hackathons, and product launches across Bangalore.
...
I hope this email finds you well. I am Ismail Kazia, Founder of GALICON GLOBAL, operating across Saudi Arabia and India.
...
I am Ismail Kazia, Founder of GALICON GLOBAL. We specialize in high-converting buyer and patient acquisition funnels for premier businesses in ${lead.city}.
...
async function runDailyOutreachEngine(maxBatch = 300) {
  console.log(`\n======================================================`);
  console.log(`👑 GALICON GLOBAL — DAILY 8:30 AM OUTREACH ENGINE`);
  ...
  const txtLines = [
    `======================================================`,
    `GALICON GLOBAL — DAILY 8:30 AM OUTREACH REPORT`,
