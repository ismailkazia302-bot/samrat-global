/**
 * SAMRAT WORLDWIDE — DAILY 8:30 AM OUTREACH & 3-MONTH FOLLOW-UP ENGINE
...
I am Ismail Kazia, Founder of SAMRAT WORLDWIDE. We produce end-to-end corporate tech summits, hackathons, and product launches across Bangalore.
...
I hope this email finds you well. I am Ismail Kazia, Founder of SAMRAT WORLDWIDE, operating across Saudi Arabia and India.
...
I am Ismail Kazia, Founder of SAMRAT WORLDWIDE. We specialize in high-converting buyer and patient acquisition funnels for premier businesses in ${lead.city}.
...
async function runDailyOutreachEngine(maxBatch = 300) {
  console.log(`\n======================================================`);
  console.log(`👑 SAMRAT WORLDWIDE — DAILY 8:30 AM OUTREACH ENGINE`);
  ...
  const txtLines = [
    `======================================================`,
    `SAMRAT WORLDWIDE — DAILY 8:30 AM OUTREACH REPORT`,
