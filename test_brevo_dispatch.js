...
async function testBrevo() {
  ...
  try {
    const res = await axios.post('https://api.brevo.com/v3/smtp/email', {
      ...
      subject: '👑 GALICON GLOBAL — AI Outreach Engine Connected Successfully!',
      htmlContent: `
        <div style="font-family: Arial, sans-serif; background: #000; color: #fff; padding: 30px; border-radius: 12px; max-width: 600px;">
          <h2 style="color: #EAB308; margin-bottom: 10px;">👑 GALICON GLOBAL</h2>
          <p style="font-size: 1.1rem; color: #fff;">Mubarak ho Ismail bhai! 🎉</p>
          <p style="color: #ccc; line-height: 1.6;">
            Aapka Brevo Email Engine ab <strong>GALICON Autonomous AI System</strong> ke saath 100% connect ho chuka hai.
          </p>
          ...
          <p style="color: #666; font-size: 0.8rem; margin: 0;">GALICON GLOBAL • Bangalore & Saudi Arabia</p>
        </div>
      `
    }, {
      headers: {
